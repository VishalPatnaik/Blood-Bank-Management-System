...
$c=mysqli_select_db($con,"cse")or die(mysqli_error());
   ...
   session_start();
    ...
    $query = mysqli_query($con,"SELECT EMailId FROM organiser WHERE EMailId='$EMailId' and Pswd='$Pswd'");
     if (mysqli_num_rows($query) != 0)
    {
     echo "<script language='javascript' type='text/javascript'> location.href='donor1.php' </script>";   
      }
      else
      {
